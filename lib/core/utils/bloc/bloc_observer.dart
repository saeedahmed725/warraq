...
class AppBlocObserver extends BlocObserver {
  ...
  void onCreate(BlocBase bloc) {
    ...
    if (bloc is Cubit) {
      log("This is a Cubit: $bloc", name: "Bloc Observer");
    } else {
      log("This is a Bloc: $bloc", name: "Bloc Observer");
    }
  }
  ...
  void onClose(BlocBase bloc) {
    super.onClose(bloc);
    if (bloc is Cubit) {
      log("Cubit is closed: $bloc", name: "Bloc Observer");
    } else {
      log("Bloc is closed: $bloc", name: "Bloc Observer");
    }
  }
}
